...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="detail">
		<form role="form" name="modifyshop" action="./modifyshop" method="post">
	<table>
	<tr>
		<th>번호</th>
		<th>지역</th>
	...
	<tr>
			<td><input type="text" value="${shopAreaVO.num }" name="num" readonly="readonly"></td>
			<td><input type="text" value="${shopAreaVO.area }" name="area"></td>
			<td><input type="text" value="${shopAreaVO.gu }" name="gu"></td>
			<td><input type="text" value="${shopAreaVO.dong }" name="dong"></td>
			<td><input type="text" value="${shopAreaVO.areanum }" name="areanum"></td>
			<td><input type="text" value="${shopAreaVO.struck }" name="struck" readonly="readonly"></td>
			<td><input type="text" value="${shopAreaVO.money }" name="money"></td>
	</tr>
		...
		<input type="button" class="modify"  value="수정하기" id="modifyshop_btn">
	</form>
	</div>
	<div class="button">
...
<script>
	...
	var formObj1=$("form[role='form']");
	$("#modifyshop_btn").on("click",function(){
		var result=confirm("정말 수정 하시겠습니까?");
		if(result==true){
			formObj1.attr("action","./modifyshop");
