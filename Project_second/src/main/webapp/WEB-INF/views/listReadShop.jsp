...
<body>
	...
	<tr>
			...
			<td>${readShop.gu }</td>
			<td>${readShop.dong }</td>
			<td>${readShop.areanum }</td>
			<td>${readShop.struck }</td>
			<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${readShop.create_date }"/></td>
		</tr>
		
	</table>
	</div>
	<div class="button">
	<form role="form" action="./shopmodify" method="get">
			<input type="hidden" name="num" value="${readShop.num }">	
	...
	<form role="form2" action="./del_shop" method="post">
		<input type="hidden" name="num" value="${readShop.num }">	
		<input type="hidden" name="page" value="${cri.page }">
		<input type="hidden" name="perPageNum" value="${cri.perPageNum }">
