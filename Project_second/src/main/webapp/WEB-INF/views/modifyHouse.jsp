...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="detail">
		<form role="form" name="modifyhouse" action="./modifyhouse" method="post">
	<table>
	<tr>
		<th>번호</th>
		<th>지역</th>
	...
	<tr>
			...
			<td><input type="text" value="${houseVO.money }" name="money"></td>
	</tr>
		...
		<input type="button" class="modify"  value="수정하기" id="modifyhouse_btn">
	</form>
...
<script>
	...
	$("#modifyhouse_btn").on("click",function(){
		var result=confirm("정말 수정 하시겠습니까?");
		if(result==true){
			formObj1.attr("action","./modifyhouse");
