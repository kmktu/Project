        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                  <span class="badge badge-pill badge-success">!!!!!!</span>공지사항을 확인하세요.
		...
		<select name="search_struck" id="search_struck">
		 ...
		 <select name="search_money" id="search_money">
			...
			<option value="money_300down" class="money">
				<c:out value="${cri.search_money eq 'money_300down'?'selected':''}" />>300이하
			</option>
			<option value="money_200down" class="money">
				<c:out value="${cri.search_money eq 'money_200down'?'selected':''}" />>200이하
			</option>
			<option value="money_100down" class="money">
				<c:out value="${cri.search_money eq 'money_100down'?'selected':''}" />>100이하
			</option>
		</select> 
		...
		<table id="data-table">
			...
			<c:forEach items="${listAll }" var="listAll">
				<tr>
					<td>${listAll.num }</td>
					<td><a
						href="./listRead${pageMaker.makeQuery(pageMaker.cri.page)}&struck=${listAll.struck }/${listAll.num}">${listAll.area }</a></td>
					<td>${listAll.gu }</td>
					<td>${listAll.dong }</td>
