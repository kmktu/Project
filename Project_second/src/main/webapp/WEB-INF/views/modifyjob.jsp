...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="detail">
		<form role="form" name="modifyjob" action="./modifyjob" method="post">
	<table>
	<tr>
		<th>번호</th>
		<th>지역</th>
	...
	<tr>
			<td><input type="text" value="${jobAreaVO.num }" name="num" readonly="readonly"></td>
			<td><input type="text" value="${jobAreaVO.area }" name="area"></td>
			<td><input type="text" value="${jobAreaVO.gu }" name="gu"></td>
			<td><input type="text" value="${jobAreaVO.dong }" name="dong"></td>
			<td><input type="text" value="${jobAreaVO.areanum }" name="areanum"></td>
			<td><input type="text" value="${jobAreaVO.struck }" name="struck" readonly="readonly"></td>
			<td><input type="text" value="${jobAreaVO.money }" name="money"></td>
	</tr>
		...
		<input type="button" class="modify"  value="수정하기" id="modifyjob_btn" >
	</form>
	</div>
	<div class="button">
...
<script>
	...
	$("#modifyjob_btn").on("click",function(){
		var result=confirm("정말 수정 하시겠습니까?");
		if(result==true){
			formObj1.attr("action","./modifyjob");
